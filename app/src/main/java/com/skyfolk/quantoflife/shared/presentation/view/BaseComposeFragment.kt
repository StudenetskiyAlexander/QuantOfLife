...
abstract class BaseComposeFragment<A: ScreenAction, S: ScreenState, E: SingleLifeEvent>: Fragment() {
...
inline fun <T> withNotNull(receiver: T?, block: T.() -> Unit): Unit = receiver?.run(block) ?: Unit